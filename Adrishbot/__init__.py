...
if ENV:
    ...
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "Adrishpdates")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "AdrishSupport")
    ...
    from Adrishbot.config import Development as Config
...
from Adrishbot.modules.helper_funcs.handlers import (
