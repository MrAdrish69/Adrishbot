...
import Adrishbot.modules.sql.users_sql as sql
...
from Adrishbot.modules import ALL_MODULES
from Adrishbot.modules.helper_funcs.chat_status import is_user_admin
from Adrishbot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text="❓ 𝘾𝙤𝙢𝙢𝙖𝙣𝙙 𝙃𝙚𝙡𝙥 ❗️", callback_data="adrish_"),
    ],
    [
...
ADRISH_IMG = f"{START_IMG}"
ADRISH_VIDA = f"{BOT_TUT}"
ADRISH_VIDB = f"{MUSICBOT_TUT}"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Adrishbot.modules." + module_name)
...
───────────────────""".format(
                ...
                reply_markup=InlineKeyboardMarkup(
                 [
                  [InlineKeyboardButton(text="📄 Network", url="https://t.me/ADRISH_NETWORK"), 
...
*Sᴇʟᴇᴄᴛ  Aʟʟ  Cᴏᴍᴍᴀɴᴅs  Fᴏʀ  Fᴜʟʟ  Hᴇʟᴘ  Oʀ  Sᴇʟᴇᴄᴛ  Cᴀᴛᴀɢᴏʀʏ  Fᴏʀ  Mᴏʀᴇ  Hᴇʟᴘ  Dᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ  Oɴ  Sᴇʟᴇᴄᴛᴇᴅ  Fɪᴇʟᴅs*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="𝙃𝙤𝙬 𝙏𝙤 𝙐𝙨𝙚 𝙈𝙚 ❓", callback_data="adrish_help"),
                     InlineKeyboardButton(text="𝙈𝙪𝙨𝙞𝙘 𝘽𝙤𝙩 🎧", callback_data="adrish_music")],
                    [InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="adrish_back"),
...
Cʟɪᴄᴋ  Bᴇʟᴏᴡ  Bᴜᴛᴛᴏɴ  Tᴏ  Aᴅᴅ  Bᴏᴛ  Iɴ  Yᴏᴜʀ  Gʀᴏᴜᴘ. Bᴀsɪᴄ  Tᴏᴜʀ  Sᴛᴀʀᴛᴇᴅ  Tᴏ  Kɴᴏᴡ  Aʙᴏᴜᴛ  Hᴏᴡ  Tᴏ  Usᴇ  Mᴇ*""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
              [[InlineKeyboardButton(text="𝙎𝙚𝙩𝙪𝙥 𝙏𝙪𝙩𝙤𝙧𝙞𝙖𝙡 🎥", callback_data="adrish_vida")],
               [InlineKeyboardButton(text="➕️ 𝘼𝙙𝙙 𝙢𝙚 𝙩𝙤 𝙔𝙤𝙪𝙧 𝙂𝙧𝙤𝙪𝙥 ➕️", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],       
                [InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="adrish_"),
                 InlineKeyboardButton(text="➡️", callback_data="adrish_helpa")]
              ]
            ),
        )
    elif query.data == "adrish_helpa":
        query.message.edit_text(
...
3). Gɪᴠɪɴɢ  Fᴜʟʟ  Pᴇʀᴍɪssɪᴏɴs  Mᴀᴋᴇ  Tɪᴀɴᴀ  Fᴜʟʟʏ  Usᴇғᴜʟ</b>""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [[InlineKeyboardButton(text="⬅️", callback_data="adrish_help"),
                InlineKeyboardButton(text="➡️", callback_data="adrish_helpb")],               
              ]
            ),
        )
    elif query.data == "adrish_helpb":
        query.message.edit_text(
            text="""*Cᴏɴɢʀᴀɢᴜʟᴀᴛɪᴏɴs,  Tʜɪꜱ  Bᴏᴛ  Nᴏᴡ  Rᴇᴀᴅʏ  Tᴏ  Mᴀɴᴀɢᴇ  Yᴏᴜʀ  Gʀᴏᴜᴘ

Hᴇʀᴇ  Aʀᴇ  Sᴏᴍᴇ  Essᴇɴᴛɪᴀʟᴛ  Tᴏ  Tʀʏ  Oɴ Aᴅʀɪsʜ.
...
Rᴇғᴇʀ  Hᴇʟᴘ  Mᴇɴᴜ  Tᴏ  Sᴇᴇ  Eᴠᴇʀʏᴛʜɪɴɢ  Iɴ  Dᴇᴛᴀɪʟ*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="adrish_helpa"),
                 InlineKeyboardButton(text="➡️", callback_data="adrish_helpc")]
                ]
            ),
        )
    elif query.data == "adrish_helpc":
        query.message.edit_text(
            text="""*× Fɪʟᴛᴇʀs
...
Sᴇɴᴅ  /chatbot  Oɴ  Aɴᴅ  Rᴇᴘʟʏ  Tᴏ  Aɴʏ  Oғ  Mʏ  Mᴇssᴀɢᴇs  Tᴏ  Sᴇᴇ  Tʜᴇ  Mᴀɢɪᴄ*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="adrish_helpb"),
                 InlineKeyboardButton(text="➡️", callback_data="adrish_helpd")]
                ]
            ),
        )
    elif query.data == "adrish_helpd":
        query.message.edit_text(
...
ᴀɴᴅ  ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ  ᴏᴘᴇɴɴᴇᴅ  ᴀᴛ  6ᴀᴍ(ɪsᴛ)  ᴛᴏ  ᴘʀᴇᴠᴇɴᴛ  ɴɪɢʜᴛ  sᴘᴀᴍs.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="adrish_helpc"),
                 InlineKeyboardButton(text="➡️", callback_data="adrish_helpe")]
                ]
            ),
        )
    elif query.data == "adrish_term":
        query.message.edit_text(
...
× Bʏ  Usɪɴɢ  Tʜɪꜱ  Bᴏᴛ  Yᴏᴜ  Aʀᴇ  Aɢʀᴇᴇᴅ  Tᴏ  Oᴜʀ  Tᴇʀᴍs  &  Cᴏɴᴅɪᴛɪᴏɴs*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="➕ 𝘼𝙡𝙡 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨 ➕", callback_data="help_back")],
                [InlineKeyboardButton(text="⬅️", callback_data="adrish_helpd"),
                InlineKeyboardButton(text="𝙈𝙖𝙞𝙣 𝙈𝙚𝙣𝙪", callback_data="adrish_")]]
            ),
        )
    elif query.data == "adrish_music":
        query.message.edit_text(
...
*Lets Enjoy Music Bot And Join Support Group*""",
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
               [[InlineKeyboardButton(text="𝙎𝙚𝙩𝙪𝙥 𝙏𝙪𝙩𝙤𝙧𝙞𝙖𝙡 🎥", callback_data="adrish_vidb")],
                [InlineKeyboardButton(text="𝙋𝙡𝙖𝙮 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="adrish_musica"),
                 InlineKeyboardButton(text="𝘽𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="adrish_musicc")],
                [InlineKeyboardButton(text="𝘼𝙙𝙢𝙞𝙣 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="adrish_musicb"),
                 InlineKeyboardButton(text="𝙀𝙭𝙩𝙧𝙖 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="adrish_musicd")],
                [InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="adrish_")]
               ]
            ),
        )
    elif query.data == "adrish_musica":
        query.message.edit_text(
            text="""✗*Here is the help for Play Commands*:

*Note*: Adrish Music Bot works on a single merged commands for Music and Video
...
/createplaylist
- Create Your Playlist on Adrish's Server with Custom Name
...
/playplaylist 
- Start playing Your Saved Playlist on Adrish Servers.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="adrish_music")]]
            ),
        )
    elif query.data == "adrish_musicb":
        query.message.edit_text(
...
Adrish has a additional feature for non-admin users who want to use admin commands
...
- Check AUTH LIST of the group.""",
    ...
    elif query.data == "adrish_musicc":
        query.message.edit_text(
            text="""✗ *Here is the help for Bot Commands*:


/start 
- Start the Adrish Music Bot.
...
/ping
- Ping the Bot and check Ram, Cpu etc stats of Adrish.""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="adrish_music")]]
            ),
        )
    elif query.data == "adrish_musicd":
        query.message.edit_text(
...
/sudolist 
- Check Sudo Users of Adrish Music Bot

/song [Track Name] or [YT Link]
- Download any track from youtube in mp3 or mp4 formats via Adrish.

/queue
- Check Queue List of Music.

/cleanmode [Enable|Disable]
- When enabled, Adrish will be deleting her 3rd last message to keep your chat clean.""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="adrish_music")]]
            ),
        )
    elif query.data == "adrish_about":
        query.message.edit_text(
...
• We also thank all the groups who rely on our Bot for this service, we hope you will always like it: we are constantly working to improve it!""",
    ...
    elif query.data == "adrish_support":
        query.message.edit_text(
    ...
    elif query.data == "adrish_network":
        query.message.edit_text(
            text="""*Adrishbot have a best network.*

*Click below Button to Get Network link.*""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="📄 𝙉𝙚𝙩𝙬𝙤𝙧𝙠", url=" https//t.me/adrish_network"),                 
                    InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="about_"),
                 ]    
                ]
            ),
        )
    elif query.data == "adrish_vida":
        query.message.reply_video(
            ADRISH_VIDA,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,           
        )
    elif query.data == "adrish_vidb":
        query.message.reply_video(
            ADRISH_VIDB,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,           
...
@run_async
def adrish_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "about_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
               [
                 [
                     InlineKeyboardButton(text="❗️ 𝘼𝙗𝙤𝙪𝙩", callback_data="adrish_about"),
                     InlineKeyboardButton(text="📄 𝙉𝙚𝙩𝙬𝙤𝙧𝙠", callback_data="adrish_network"),
                 ],
                 [  
                    InlineKeyboardButton(text="🫂 𝙎𝙪𝙥𝙥𝙤𝙧𝙩", callback_data="adrish_support"),
                    InlineKeyboardButton(text="👨‍✈️ 𝙊𝙬𝙣𝙚𝙧", url=f"t.me/{OWNER_USERNAME}"),
                 ],
                 [
                     InlineKeyboardButton(text="𝙏𝙚𝙧𝙢𝙨 𝘼𝙣𝙙 𝘾𝙤𝙣𝙙𝙞𝙩𝙞𝙤𝙣𝙨❗️", callback_data="adrish_term"),
                 ],
                 [
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="adrish_")]]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "𝘼𝙙𝙧𝙞𝙨𝙝𝘽𝙤𝙩 𝙐𝙥𝙙𝙖𝙩𝙚𝙙 𝙎𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✅𝘽𝙖𝙗𝙮")
        except Unauthorized:
            LOGGER.warning(
