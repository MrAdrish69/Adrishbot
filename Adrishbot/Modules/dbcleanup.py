...
import Adrishbot.modules.sql.global_bans_sql as gban_sql
import Adrishbot.modules.sql.users_sql as user_sql
from Adrishbot import DEV_USERS, OWNER_ID, dispatcher
